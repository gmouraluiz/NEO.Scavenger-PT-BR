...
Function conditions(id, attr, Line)		
	Select case id
		...
		case 546
			Select case attr
				case "strName"
					Line = Replace(Line, "Using a smudge stick", "Usando galho de incenso")
				case "strDesc"
					Line = Replace(Line, "is using a smudge stick", "esta usando galho de incenso")
			End Select
		case 547
			Select case attr
				case "strName"
		...
		case 796
			Select case attr
				case "strName"
					Line = Replace(Line, "Use Roadmap", "Use o guia de rota")
				case "strDesc"
					Line = Replace(Line, "is using a roadmap", "esta usando um guia de rota")
			End Select
		case 797
			Select case attr
				case "strName"
...
Function ingredients(id, attr, Line)	
	Select case id
		...
		case 103
			Select case attr
				case "strName"
					Line = Replace(Line, "wooden rifle stock", "cabo de rifle de madeira")
			End Select
		case 104
			Select case attr
				case "strName"
		...
		case 112
			Select case attr
				case "strName"
					Line = Replace(Line, "smudge stick", "galho de incenso")
			End Select
		case 113
			Select case attr
				case "strName"
	...
	Select case id
		...
		case 11
			Select case attr
				...
				case "strDesc"
					Line = Replace(Line, "bronze talisman on a braided leather string", "talisma de bronze em uma corda de couro amarrada")
			End Select
		case 12
			Select case attr
				case "strName"
		...
		case 146
			Select case attr
				case "strName"
					Line = Replace(Line, "a scrap of paper", "pedaco de papel")
				case "strDesc"
		...
		case 272
			Select case attr
				case "strName"
					Line = Replace(Line, "vehicle", "veiculo")
				case "strDesc"
					Line = Replace(Line, "plastic sled", "treno de plastico")
			End Select
		case 273
			Select case attr
				case "strName"
					Line = Replace(Line, "vehicle", "veiculo")
				case "strDesc"
					Line = Replace(Line, "sled w/strap", "treno c/alca")
			End Select
		case 274
			Select case attr
				case "strName"
					Line = Replace(Line, "branch", "galho")
				case "strDesc"
					Line = Replace(Line, "large branch from a tree", "grande galho de uma arvore")
			End Select
		case 275
			Select case attr
				case "strName"
		...
		case 278
			Select case attr
				case "strName"
					Line = Replace(Line, "blade", "lamina")
				case "strDesc"
					Line = Replace(Line, "shiv", "vidro")
			End Select
		case 279
			Select case attr
				case "strName"
					Line = Replace(Line, "bow", "arco")
				case "strDesc"
					Line = Replace(Line, "crude bow", "arco grosseiro")
				case "strDescAlt"
					Line = Replace(Line, "greenwood bow", "arco de madeira verde")
			End Select
		case 280
			Select case attr
				case "strName"
		...
		case 281
			Select case attr
				case "strName"
					Line = Replace(Line, "bow", "arco")
				case "strDesc"
					Line = Replace(Line, "bow w/strap", "arco c/alca")
				case "strDescAlt"
					Line = Replace(Line, "compound bow w/strap", "arco composto c/alca")
			End Select
		case 282
			Select case attr
				case "strName"
					Line = Replace(Line, "ammo", "municao")
				case "strDesc"
					Line = Replace(Line, "hunting arrow", "flecha de caca")
				case "strDescAlt"
					Line = Replace(Line, "broadhead arrow", "flecha de cabeca larga")
			End Select
		case 283
			Select case attr
				case "strName"
					Line = Replace(Line, "ammo", "municao")
				case "strDesc"
					Line = Replace(Line, "crude arrow", "flecha bruta")
				case "strDescAlt"
					Line = Replace(Line, "crude piercing arrow", "flexa bruto/penetrante")
			End Select
		case 284
			Select case attr
				case "strName"
				...
				case "strDesc"
					Line = Replace(Line, "crude arrow", "flecha bruta")
				case "strDescAlt"
					Line = Replace(Line, "crude broadhead arrow", "flexa bruto/cabeca larga")
			End Select
		case 285
			Select case attr
				case "strName"
					Line = Replace(Line, "small parts", "pequenas partes")
				case "strDesc"
					Line = Replace(Line, "pebbles", "seixos")
			End Select
		case 286
			Select case attr
				case "strName"
					Line = Replace(Line, "medium parts", "medias partes")
				case "strDesc"
					Line = Replace(Line, "stones", "pedras")
			End Select
		case 287
			Select case attr
				case "strName"
		...
		case 288
			Select case attr
				...
				case "strName"
					Line = Replace(Line, "Detective", "Detetive")
			End Select
		case 289
			Select case attr
				case "strName"
		...
		case 296
			Select case attr
				case "strName"
					Line = Replace(Line, "rifle", "rifle")
				case "strDesc"
					Line = Replace(Line, "military rifle", "rifle militar")
			End Select
		case 297
			Select case attr
				case "strName"
					Line = Replace(Line, "rifle", "rifle")
				case "strDesc"
					Line = Replace(Line, "hunting rifle w/strap", "rifle de caca com alca")
			End Select
		case 298
			Select case attr
				case "strName"
					Line = Replace(Line, "spear", "lanca")
				case "strDesc"
		...
		case 301
			Select case attr
				...
				case "strDesc"
					Line = Replace(Line, "battery", "bateria")
				case "strDescAlt"
					Line = Replace(Line, "military micro cell", "micro celular militar")
			End Select
		case 302
			Select case attr
				case "strName"
					Line = Replace(Line, "check body", "verifique o corpo")
				case "strDesc"
					Line = Replace(Line, "Check Body for Loot", "Verifique o corpo por saque")
			End Select
		case 303
			Select case attr
				case "strName"
					Line = Replace(Line, "surrender offer", "oferta de entrega")
				case "strDesc"
					Line = Replace(Line, "Surrender Offer", "Oferta de entrega")
			End Select
		case 304
			Select case attr
				case "strName"
					Line = Replace(Line, "surrender accept", "entrega aceita")
				case "strDesc"
					Line = Replace(Line, "Surrender Accept", "Entrega aceita")
			End Select
		case 305
			Select case attr
				case "strName"
					Line = Replace(Line, "surrender demand", "pedido de rendicao")
				case "strDesc"
					Line = Replace(Line, "Surrender Demand", "Pedido de rendicao")
			End Select
		case 306
			Select case attr
				case "strName"
					Line = Replace(Line, "surrender agree", "concordar com rendicao")
				case "strDesc"
					Line = Replace(Line, "Surrender Agree", "Concordar com rendicao")
			End Select
		case 307
			Select case attr
				case "strName"
					Line = Replace(Line, "corpse", "cadaver")
				case "strDesc"
					Line = Replace(Line, "dogman corpse", "cadaver de Lobisomem")
			End Select
		case 308
			Select case attr
				case "strName"
					Line = Replace(Line, "food", "comida")
				case "strDesc"
					Line = Replace(Line, "medium chunk of meat (raw)", "pedaco medio de carne (crua)")
			End Select
		case 309
			Select case attr
				case "strName"
					Line = Replace(Line, "food", "comida")
				case "strDesc"
					Line = Replace(Line, "medium chunk of meat (spoiled)", "pedaco medio de carne (estragado)")
			End Select
		case 310
			Select case attr
				case "strName"
					Line = Replace(Line, "food", "comida")
				case "strDesc"
					Line = Replace(Line, "medium chunk of meat (cooked)", "pedaco medio de carne (cozido)")
			End Select
		case 311
			Select case attr
				case "strName"
					Line = Replace(Line, "food", "comida")
				case "strDesc"
					Line = Replace(Line, "medium chunk of meat (cured)", "pedaco medio de carne (curado)")
			End Select
		case 312
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, "dogman fur coat", "casaco de peles de Lobisomem")
			End Select
		case 313
			Select case attr
				case "strName"
					Line = Replace(Line, "corpse", "cadaver")
				case "strDesc"
					Line = Replace(Line, "humanoid corpse", "cadaver de humano")
			End Select
		case 314
			Select case attr
				case "strName"
					Line = Replace(Line, "small animal hide", "pele de animal pequeno")
				case "strDesc"
					Line = Replace(Line, "small chunk of fur", "pequeno pedaco de pelos")
			End Select
		case 315
			Select case attr
				case "strName"
					Line = Replace(Line, "small animal hide", "pele de animal pequeno")
				case "strDesc"
					Line = Replace(Line, "small chunk of hide", "pequeno pedaco de pele")
			End Select
		case 316
			Select case attr
				case "strName"
					Line = Replace(Line, "corpse", "cadaver")
				case "strDesc"
					Line = Replace(Line, "deer corpse", "cadaver de cervo")
			End Select
		case 317
			Select case attr
				case "strName"
					Line = Replace(Line, "corpse", "cadaver")
				case "strDesc"
					Line = Replace(Line, "Enfield Horror corpse", "cadaver de Enfield Horror")
			End Select
		case 318
			Select case attr
				case "strName"
					Line = Replace(Line, "flashlight", "lanterna")
				case "strDesc"
					Line = Replace(Line, "Circuit Shack "&chr(34)&"Carter"&chr(34)&" flashlight (off)", "Lanterna de circuito "&chr(34)&"Carter"&chr(34)&" (desligada)")
			End Select
		case 319
			Select case attr
				case "strName"
					Line = Replace(Line, "battery", "bateria")
				case "strDesc"
					Line = Replace(Line, "AA battery", "AA bateria")
			End Select
		case 320
			Select case attr
				case "strName"
					Line = Replace(Line, "a scrap of paper", "pedaco de papel")
				case "strDesc"
					Line = Replace(Line, "scrap of paper", "pedaco de papel")
			End Select
		case 321
			Select case attr
				case "strName"
					Line = Replace(Line, "surrender offer (player)", "oferta de entrega (jogador)")
				case "strDesc"
					Line = Replace(Line, "Surrender Offer", "Oferta de entrega")
			End Select
		case 322
			Select case attr
				case "strName"
					Line = Replace(Line, "Laptop (locked)", "Laptop (bloqueado)")
				case "strDesc"
					Line = Replace(Line, "laptop (off)", "laptop (desligado)")
			End Select
		case 323
			Select case attr
				case "strName"
		...
		case 324
			Select case attr
				case "strName"
					Line = Replace(Line, "Laptop (locked)", "Laptop (bloqueado)")
				case "strDesc"
					Line = Replace(Line, "laptop (closed)", "laptop (fechado)")
			End Select
		case 325
			Select case attr
				case "strName"
		...
		case 326
			Select case attr
				case "strName"
					Line = Replace(Line, "Laptop", "Laptop")
				case "strDesc"
					Line = Replace(Line, "laptop (off)", "laptop (desliado)")
			End Select
		case 327
			Select case attr
				case "strName"
		...
		case 329
			Select case attr
				case "strName"
					Line = Replace(Line, "Nan00", "Nan00")
				case "strDesc"
					Line = Replace(Line, "laptop cracking software", "software de cracking para laptop")
			End Select
		case 330
			Select case attr
				case "strName"
					Line = Replace(Line, "battery", "bateria")
				case "strDesc"
					Line = Replace(Line, "iSlab battery", "bateria de iSlab")
			End Select
		case 331
			Select case attr
				case "strName"
					Line = Replace(Line, "iSlab (locked)", "iSlab (bloqueado)")
				case "strDesc"
					Line = Replace(Line, "iSlab tablet (locked)", "iSlab tablet (bloqueado)")
			End Select
		case 332
			Select case attr
				case "strName"
					Line = Replace(Line, "iSlab", "iSlab")
				case "strDesc"
					Line = Replace(Line, "iSlab tablet (off)", "iSlab tablet (desligado)")
			End Select
		case 333
			Select case attr
				case "strName"
					Line = Replace(Line, "iSlab", "iSlab")
				case "strDesc"
					Line = Replace(Line, "iSlab tablet (on)", "iSlab tablet (ligado)")
			End Select
		case 334
			Select case attr
				case "strName"
					Line = Replace(Line, "battery", "bateria")
				case "strDesc"
					Line = Replace(Line, "cellphone battery", "bateria de celular")
			End Select
		case 335
			Select case attr
				case "strName"
					Line = Replace(Line, "battery", "bateria")
				case "strDesc"
					Line = Replace(Line, "smartphone battery", "bateria de smartphone")
			End Select
		case 336
			Select case attr
				case "strName"
					Line = Replace(Line, "Smartphone (locked)", "Smartphone (bloqueado)")
				case "strDesc"
					Line = Replace(Line, "off", "desligado")
			End Select
		case 337
			Select case attr
				case "strName"
					Line = Replace(Line, "Smartphone (locked)", "Smartphone (bloqueado)")
				case "strDesc"
					Line = Replace(Line, "locked", "bloqueado")
			End Select
		case 338
			Select case attr
				case "strName"
		...
		case 339
			Select case attr
				case "strName"
					Line = Replace(Line, "Smartphone", "Smartphone")
				case "strDesc"
					Line = Replace(Line, "on", "ligado")
			End Select
		case 340
			Select case attr
				case "strName"
					Line = Replace(Line, "Cellphone (locked)", "celular (bloqueado)")
				case "strDesc"
					Line = Replace(Line, "cellphone (off)", "celular (desligado)")
			End Select
		case 341
			Select case attr
				case "strName"
		...
		case 342
			Select case attr
				case "strName"
					Line = Replace(Line, "Cellphone", "Celular")
				case "strDesc"
					Line = Replace(Line, "cellphone (off)", "celular (desligado)")
			End Select
		case 343
			Select case attr
				case "strName"
					Line = Replace(Line, "Cellphone", "Celular")
				case "strDesc"
					Line = Replace(Line, "cellphone (on)", "celular (ligado)")
			End Select
		case 344
			Select case attr
				case "strName"
				...
				case "strDesc"
					Line = Replace(Line, "iSl-AK", "iSl-AK")
				case "strDescAlt"
					Line = Replace(Line, "iSl-AK tablet cracking software", "software de cracking de tablet iSl-AK")
			End Select
		case 345
			Select case attr
				case "strName"
					Line = Replace(Line, "Software", "Software")
				case "strDesc"
					Line = Replace(Line, "5MR-7", "5MR-7")
				case "strDescAlt"
					Line = Replace(Line, "5MR-7 smartphone cracking software", "software de cracking de smartphone 5MR-7")
			End Select
		case 346
			Select case attr
				case "strName"
					Line = Replace(Line, "Software", "Software")
				case "strDesc"
					Line = Replace(Line, "Br1nG", "Br1nG")
				case "strDescAlt"
					Line = Replace(Line, "Br1nG cellphone cracking software", "software de cracking de celular Br1nG")
			End Select
		case 347
			Select case attr
				case "strName"
					Line = Replace(Line, "Software", "Software")
				case "strDesc"
					Line = Replace(Line, "Lamp software (tablet)", "Software de lampada (tablet)")
			End Select
		case 348
			Select case attr
				case "strName"
					Line = Replace(Line, "Software", "Software")
				case "strDesc"
					Line = Replace(Line, "GPS software (tablet)", "Programa de GPS (tablet)")
			End Select
		case 349
			Select case attr
				case "strName"
					Line = Replace(Line, "Software", "Software")
				case "strDesc"
					Line = Replace(Line, "Lamp software (smartphone)", "Software de lampada (smartphone)")
			End Select
		case 350
			Select case attr
				case "strName"
					Line = Replace(Line, "Software", "Software")
				case "strDesc"
					Line = Replace(Line, "GPS software (smartphone)", "Programa de GPS (smartphone)")
			End Select
		case 351
			Select case attr
				case "strName"
					Line = Replace(Line, "iSlab", "iSlab")
				case "strDesc"
					Line = Replace(Line, "iSlab tablet (lamp)", "iSlab tablet (lampada)")
			End Select
		case 352
			Select case attr
				case "strName"
					Line = Replace(Line, "Smartphone", "Smartphone")
				case "strDesc"
					Line = Replace(Line, "smartphone (lamp)", "smartphone (lampada)")
			End Select
		case 353
			Select case attr
				case "strName"
					Line = Replace(Line, "flashlight", "lanterna")
				case "strDesc"
					Line = Replace(Line, "flashlight (on)", "lanterna (ligada)")
			End Select
		case 354
			Select case attr
				case "strName"
					Line = Replace(Line, "headwear", "chapeu")
				case "strDesc"
					Line = Replace(Line, "night vision goggles (on)", "oculos de visao noturna (ligado)")
			End Select
		case 355
			Select case attr
				case "strName"
					Line = Replace(Line, "Data", "Dados")
				case "strDesc"
					Line = Replace(Line, "data file", "arquivo de dados")
			End Select
		case 356
			Select case attr
				case "strName"
					Line = Replace(Line, "memory stick", "cartao de memoria")
				case "strDesc"
					Line = Replace(Line, "cheap memory stick", "cartao de memoria (pendrive)")
			End Select
		case 357
			Select case attr
				case "strName"
					Line = Replace(Line, "food (human meat)", "comida (carne humana)")
				case "strDesc"
					Line = Replace(Line, "medium chunk of meat (raw) (human)", "pedaco medio de carne (crua, humano)")
			End Select
		case 358
			Select case attr
				case "strName"
					Line = Replace(Line, "food", "comida")
				case "strDesc"
					Line = Replace(Line, "medium chunk of meat (spoiled) (human)", "pedaco medio de carne (estragado, humano)")
			End Select
		case 359
			Select case attr
				case "strName"
					Line = Replace(Line, "food", "comida")
				case "strDesc"
					Line = Replace(Line, "medium chunk of meat (cooked) (human)", "pedaco medio de carne (cozido, humano)")
			End Select
		case 360
			Select case attr
				case "strName"
					Line = Replace(Line, "food", "comida")
				case "strDesc"
					Line = Replace(Line, "medium chunk of meat (cured) (human)", "pedaco medio de carne (curado, humano)")
			End Select
		case 361
			Select case attr
				case "strName"
					Line = Replace(Line, "food", "comida")
				case "strDesc"
					Line = Replace(Line, "small chunk of meat (raw) (human)", "pequeno pedaco de carne (crua, humano)")
			End Select
		case 362
			Select case attr
				case "strName"
					Line = Replace(Line, "food", "comida")
				case "strDesc"
					Line = Replace(Line, "small chunk of meat (spoiled) (human)", "pequeno pedaco de carne (estragado, humano)")
			End Select
		case 363
			Select case attr
				case "strName"
					Line = Replace(Line, "food", "comida")
				case "strDesc"
					Line = Replace(Line, "small chunk of meat (cooked) (human)", "pequeno pedaco de carne (cozido, humano)")
			End Select
		case 364
			Select case attr
				case "strName"
					Line = Replace(Line, "food", "comida")
				case "strDesc"
					Line = Replace(Line, "small chunk of meat (cured) (human)", "pequeno pedaco de carne (curado, humano)")
			End Select
		case 365
			Select case attr
				case "strName"
					Line = Replace(Line, "take eyes", "pegue os olhos")
				case "strDesc"
					Line = Replace(Line, "Take Eyes", "Pegue os olhos")
			End Select
		case 366
			Select case attr
				...
				case "strDesc"
					Line = Replace(Line, "water", "agua")
				case "strDescAlt"
					Line = Replace(Line, "water (poisoned, sterilized)", "agua (envenenada, esterilizada)")
			End Select
		case 367
			Select case attr
				case "strName"
					...
					End If
				case "strDesc"
					Line = Replace(Line, "water (sterilized)", "agua (esterilizada)")
				case "strDescAlt"
					Line = Replace(Line, "water (poisoned, sterilized)", "agua (envenenada, esterilizada)")
			End Select
		case 368
			Select case attr
				case "strName"
					...
					End If
				case "strDesc"
					Line = Replace(Line, "water (analyzed)", "agua (analisada)")
			End Select
		case 369
			Select case attr
				case "strName"
					Line = Replace(Line, "water tester", "testador de agua")
				case "strDesc"
					Line = Replace(Line, "Digital Water Tester", "testador de agua digital")
			End Select
		case 370
			Select case attr
				case "strName"
		...
		case 371
			Select case attr
				case "strName"
					Line = Replace(Line, "corpse", "cadaver")
				case "strDesc"
					Line = Replace(Line, "Merga Wraith corpse", "cadaver de Merga Wraith")
			End Select
		case 372
			Select case attr
				case "strName"
					...
					End If
				case "strDesc"
					Line = Replace(Line, "sheaf of letters from Ambrose Bierce, cataloging creatures and occurrences which lack a rational explanation", "punhados de cartas de Ambrose Bierce, catalogando criaturas e ocorrencias que nao possuem uma explicacao racional")
			End Select
		case 373
			Select case attr
				case "strName"
		...
		case 374
			Select case attr
				case "strName"
					Line = Replace(Line, "book", "livro")
				case "strDesc"
					Line = Replace(Line, "illustrated children's book in an unknown language", "livro ilustrado infantil em uma lingua desconhecida")
			End Select
		case 375
			Select case attr
				case "strName"
					Line = Replace(Line, "Merga loupe", "Merga loupe")
				case "strDesc"
					Line = Replace(Line, "Merga Loupe", "Merga Loupe")
			End Select
		case 376
			Select case attr
				case "strName"
					Line = Replace(Line, "stone tablet", "tableta de pedra")
				case "strDesc"
					Line = Replace(Line, "fragments of clay with some sort of cuneiform engravings", "fragmentos de barro com algum tipo de gravuras cuneiformes")
			End Select
		case 377
			Select case attr
				case "strName"
					Line = Replace(Line, "terrain resource", "recurso de terreno")
				case "strDesc"
					Line = Replace(Line, "unlicensed power tap", "tomada eletrica sem licenca")
					Line = Replace(Line, "to add more charges", "para adicionar mais carga")
			End Select
		case 378
			Select case attr
				case "strName"
		...
		case 380
			Select case attr
				case "strName"
					Line = Replace(Line, "roast meat on cabbage", "Assado de carne no repolho")
				case "strDesc"
					Line = Replace(Line, "roast "&chr(34)&"track rabbit"&chr(34)&" over cabbage", "Assado "&chr(34)&"coelho de trilha"&chr(34)&" sobre repolho")
			End Select
		case 381
			Select case attr
				case "strName"
					Line = Replace(Line, "donner meat over sprouts", "dar carne sobre brotos")
				case "strDesc"
					Line = Replace(Line, "donner meat over fried sprouts", "dar carne sobre brotos fritos")
			End Select
		case 382
			Select case attr
				case "strName"
					Line = Replace(Line, "donner meat over cabbage", "dar carne sobre repolho")
				case "strDesc"
					Line = Replace(Line, "donner meat over fried cabbage", "dar carne sobre repolho frito")
			End Select
		case 383
			Select case attr
				case "strName"
					Line = Replace(Line, "fried tofu sticks", "varas fritas de tofu")
				case "strDesc"
					Line = Replace(Line, "fried tofu sticks", "varas fritas de tofu")
			End Select
		case 384
			Select case attr
				case "strName"
					Line = Replace(Line, "drop item", "soltar item")
				case "strDesc"
					Line = Replace(Line, "Drop Item", "Soltar item")
			End Select
		case 385
			Select case attr
				case "strName"
					Line = Replace(Line, "disengage offer", "oferta de liberdade")
				case "strDesc"
					Line = Replace(Line, "disengage offer", "oferta de liberdade")
			End Select
		case 386
			Select case attr
				case "strName"
					Line = Replace(Line, "disengage accept", "liberdade aceita")
				case "strDesc"
					Line = Replace(Line, "disengage accept", "liberdade aceita")
			End Select
		case 387
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (legs)", "roupas (pernas)")
				case "strDesc"
					Line = Replace(Line, "khaki cargo pants", "calcas de carga khaki")
			End Select
		case 388
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (legs)", "roupas (pernas)")
				case "strDesc"
					Line = Replace(Line, "khaki cargo shorts", "shorts de carga khaki")
			End Select
		case 389
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (legs)", "roupas (pernas)")
				case "strDesc"
					Line = Replace(Line, "black cargo pants", "calcas de carga preta")
			End Select
		case 390
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (shoes)", "roupas (sapatos)")
				case "strDesc"
					Line = Replace(Line, "tactical boot (left)", "bota tatica (esquerda)")
			End Select
		case 391
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (shoes)", "roupas (sapatos)")
				case "strDesc"
					Line = Replace(Line, "tactical boot (right)", "bota tatica (direito)")
			End Select
		case 392
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, "black shirt", "camisa preta")
			End Select
		case 393
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (gloves)", "roupas (luvas)")
				case "strDesc"
					Line = Replace(Line, "tactical glove", "luva tatica")
			End Select
		case 394
			Select case attr
				case "strName"
		...
		case 395
			Select case attr
				case "strName"
					Line = Replace(Line, "headwear", "chapeu")
				case "strDesc"
					Line = Replace(Line, "tactical helmet", "capacete tatico")
			End Select
		case 396
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, "tactical armor vest", "colete de armadura tatica")
			End Select
		case 397
			Select case attr
				case "strName"
					Line = Replace(Line, "status", "status")
				case "strDesc"
					Line = Replace(Line, "no helmets", "sem capacetes")
			End Select
		case 398
			Select case attr
				case "strName"
				...
				case "strDesc"
					Line = Replace(Line, "hunting rifle", "rifle de caca")
				case "strDescAlt"
					Line = Replace(Line, "12-gauge shotgun", "12-gauge shotgun")
			End Select
		case 399
			Select case attr
				case "strName"
					Line = Replace(Line, "rifle", "rifle")
				case "strDesc"
					Line = Replace(Line, "military rifle w/strap", "rifle militar com alca")
				case "strName"
					Line = Replace(Line, "12-gauge shotgun w/strap", "12-gauge shotgun c/alca")
			End Select
		case 400
			Select case attr
				case "strName"
					...
					End If
				case "strDesc"
					Line = Replace(Line, "Detroit Megacity tracking bracelet (used)", "Bracelete de rastreamento Megacity de Detroit (usado)")
			End Select
		case 401
			Select case attr
				case "strName"
					Line = Replace(Line, "smudge stick", "galho de incenso")
				case "strDesc"
					Line = Replace(Line, "Giizhik smudge stick (unlit)", "Galho de incendo Giizhik (apagado)")
			End Select
		case 402
			Select case attr
				case "strName"
					Line = Replace(Line, "smudge stick", "galho de incenso")
				case "strDesc"
					Line = Replace(Line, "Giizhik smudge stick (lit)", "Galho de incendo Giizhik (aceso)")
			End Select
		case 403
			Select case attr
				case "strName"
		...
		case 404
			Select case attr
				...
				case "strDesc"
					Line = Replace(Line, "crude bow", "arco grosseiro")
				case "strName"
					Line = Replace(Line, "Anishinaabe bow", "arco Anishinaabe")
			End Select
		case 405
			Select case attr
				case "strName"
					Line = Replace(Line, "club", "bastao")
				case "strDesc"
					Line = Replace(Line, "club", "bastao")
				case "strDescAlt"
					Line = Replace(Line, "Anishinaabe war club", "bastao de guerra Anishinaabe")
			End Select
		case 406
			Select case attr
				case "strName"
					Line = Replace(Line, "bag", "bolsa")
				case "strDesc"
					Line = Replace(Line, "soft birch bag", "bolsa de betula")
			End Select
		case 407
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, "hide long coat", "sobretudo longo")
			End Select
		case 408
			Select case attr
				case "strName"
					Line = Replace(Line, "radio DMC support", "suporte de radio DMC")
				case "strDesc"
					Line = Replace(Line, "radio DMC support", "suporte de radio DMC")
			End Select
		case 409
			Select case attr
				case "strName"
					Line = Replace(Line, "call DMC backup", "chamar o backup do DMC")
				case "strDesc"
					Line = Replace(Line, "call DMC backup", "chamar o backup do DMC")
			End Select
		case 410
			Select case attr
				case "strName"
					Line = Replace(Line, "ammo", "municao")
				case "strDesc"
					Line = Replace(Line, "some strange-looking bullets", "algumas balas de aparencia estranha")
			End Select
		case 411
			Select case attr
				case "strName"
					Line = Replace(Line, "rifle", "rifle")
				case "strDesc"
					Line = Replace(Line, "crazy-looking gun", "arma de aparencia louca")
			End Select
		case 412
			Select case attr
				case "strName"
					Line = Replace(Line, "crawl towards", "rastejar para")
				case "strDesc"
					Line = Replace(Line, "crawl towards", "rastejar para")
			End Select
		case 413
			Select case attr
				case "strName"
					Line = Replace(Line, "crawl away", "rastejar")
				case "strDesc"
					Line = Replace(Line, "crawl away", "rastejar")
			End Select
		case 414
			Select case attr
				case "strName"
					Line = Replace(Line, "advance (ignore)", "avancar (ignorar)")
				case "strDesc"
					Line = Replace(Line, "Advance", "Avancar")
			End Select
		case 415
			Select case attr
				case "strName"
					Line = Replace(Line, "exit battle", "saida da batalha")
				case "strDesc"
					Line = Replace(Line, "Exit Battle", "Saida da batalha")
			End Select
		case 416
			Select case attr
				case "strName"
					Line = Replace(Line, "scavenge location", "lugar vasculhado")
				case "strDesc"
					Line = Replace(Line, "Gyges Cryo Facility", "Gyges Cryo Facility")
			End Select
		case 417
			Select case attr
				case "strName"
		...
		case 418
			Select case attr
				...
				case "strDesc"
					Line = Replace(Line, "consume/use", "consumir/usar")
					Line = Replace(Line, "this to enter the house at Seven Gables Road", "para voltar a entrar em Seven Gables Road")
			End Select
		case 419
			Select case attr
				case "strName"
				...
				case "strDesc"
					Line = Replace(Line, "consume/use", "consumir/usar")
					Line = Replace(Line, "this to enter Zom Zom's", "para entrar em Zom Zom's")
			End Select
		case 420
			Select case attr
				case "strName"
				...
				case "strDesc"
					Line = Replace(Line, "consume/use", "consumir/usar")
					Line = Replace(Line, "this to enter the Strange Forest", "para entrar em Estranha Floresta")
			End Select
		case 421
			Select case attr
				case "strName"
				...
				case "strDesc"
					Line = Replace(Line, "consume/use", "consumir/usar")
					Line = Replace(Line, "this to enter the Isotope Mine", "para entrar em Mina de isotopo")
			End Select
		case 422
			Select case attr
				case "strName"
				...
				case "strDesc"
					Line = Replace(Line, "consume/use", "consumir/usar")
					Line = Replace(Line, "this to enter Allegan Fairgrounds", "para entrar em Allegan Fairgrounds")
			End Select
		case 423
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, "white Allegan Fairgrounds T-shirt", "camiseta branca de Allegan Fairgrounds")
			End Select
		case 425
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, "red Allegan Fairgrounds T-shirt", "camiseta vermelha de Allegan Fairgrounds")
			End Select
		case 426
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, "Corn-a-Cola T-shirt", "camiseta Corn-a-Cola")
			End Select
		case 427
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, "banana T-shirt", "camiseta de banana")
			End Select
		case 428
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, chr(34)&"3 Dog Moon"&chr(34)&" T-shirt", "camiseta de lobo" )
			End Select
		case 429
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, "Blue Frog sash", "faixa de Blue Frog")
			End Select
		case 430
			Select case attr
				case "strName"
					Line = Replace(Line, "gas mask cartridge", "cartucho de mascara de gas")
				case "strDesc"
					Line = Replace(Line, "Gas Mask Cartridge", "Cartucho de mascara de gas")
			End Select		
		case 431
			Select case attr
				case "strName"
					Line = Replace(Line, "headwear", "chapeu")
				case "strDesc"
					Line = Replace(Line, "Gas Mask", "Mascara de Gas")
			End Select
		case 432
			Select case attr
				case "strName"
					Line = Replace(Line, "exit battle (crawl)", "sair da batalha (rastreamento)")		
				case "strDesc"
					Line = Replace(Line, "Exit Battle (Crawl)", "Sair da batalha (rastreamento)")
			End Select
		case 433
			Select case attr
				case "strName"
					Line = Replace(Line, "scavenge location", "lugar vasculhado")
				case "strDesc"
					Line = Replace(Line, "Black Swamp ruins", "Ruinas do Pantano Negro")
			End Select
		case 434
			Select case attr
				case "strName"
					Line = Replace(Line, "scavenge location", "lugar vasculhado")
				case "strDesc"
					Line = Replace(Line, "swamp crash site", "local do ruinas do pantano")
			End Select
		case 435
			Select case attr
				case "strName"
					Line = Replace(Line, "scavenge location", "lugar vasculhado")
				case "strDesc"
					Line = Replace(Line, "forest crash site", "site de ruinas da floresta")
			End Select
		case 436
			Select case attr
				case "strName"
					Line = Replace(Line, "small parts", "pequenas partes")
				case "strDesc"
					Line = Replace(Line, "plastic shard", "fragmento de plastico")
			End Select
		case 447
			Select case attr
				case "strName"
					Line = Replace(Line, "sealed drum labeled", "tambor selado rotulado")
				case "strDesc"
					Line = Replace(Line, "sealed drum of oral inoculant formula", "tambor selado de formula oral inoculante")
			End Select
		case 448
			Select case attr
				case "strName"
					Line = Replace(Line, "key fob", "chave de fob")
				case "strDesc"
					Line = Replace(Line, "key fob", "chave de fob")
			End Select
		case 449
			Select case attr
				case "strName"
					...
					End If
				case "strDesc"
					Line = Replace(Line, "some pages from the Blue Frog book", "algumas paginas do livro Blue Frog")
			End Select
		case 450
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, "Sapphire Lily sash", "faixa de Sapphire Lily")
			End Select
		case 451
			Select case attr
				case "strName"
					Line = Replace(Line, "ground fixture", "instalacao terrestre")
				case "strDesc"
					Line = Replace(Line, "your confiscated items", "seus itens confiscados")
			End Select
		case 452
			Select case attr
				case "strName"
		...
		case 469
			Select case attr
				case "strName"
					Line = Replace(Line, "medium parts", "medias partes")
				case "strDesc"
					Line = Replace(Line, "metal box", "caixa de metal")
				case "strDescAlt"
					Line = Replace(Line, "4mm Gauss gun receiver", "receiver de Pistola 4mm Gauss")
			End Select
		case 470
			Select case attr
				case "strName"
					Line = Replace(Line, "medium parts", "medias partes")
				case "strDesc"
					Line = Replace(Line, "metal box with electrical connectors", "caixa metalica com conectores eletricos")
				case "strDescAlt"
					Line = Replace(Line, "stage-switching circuit", "circuito de comutacao de estagio")
			End Select
		case 471
			Select case attr
				case "strName"
					Line = Replace(Line, "medium parts", "medias partes")
				case "strDesc"
					Line = Replace(Line, "small metal box with switches", "pequena caixa de metal com interruptores")
				case "strDescAlt"
					Line = Replace(Line, "charging circuit", "circuito de carga")
			End Select
		case 472
		...
		case 473
			Select case attr
				case "strName"
					Line = Replace(Line, "corpse", "cadaver")
				case "strDesc"
					Line = Replace(Line, "UAV wreckage spare parts", "pecas sobressalentes de um destroco UAV")
			End Select
		case 474
			Select case attr
				case "strName"
					Line = Replace(Line, "Drone Armor", "Drone Armor")
				case "strDesc"
					Line = Replace(Line, "drone fuselage armor", "armadura de fuselagem de drone")
			End Select
		case 475
			Select case attr
				case "strName"
					Line = Replace(Line, "bag", "bolsa")
				case "strDesc"
					Line = Replace(Line, "children's backpack", "mochila infantil")
			End Select
		case 476
			Select case attr
				case "strName"
					Line = Replace(Line, "campfire (lit) (ATN)", "fogueira (acesa)  (ATN)")
				case "strDesc"
					Line = Replace(Line, "lit campfire", "fogueira acesa")
			End Select
		case 477
			Select case attr
				case "strName"
					Line = Replace(Line, "food", "comida")
				case "strDesc"
					Line = Replace(Line, "handful of potato chips", "punhado de batata frita")
			End Select
		case 478
			Select case attr
				case "strName"
					Line = Replace(Line, "a scrap of foil", "pedaco de papel aluminio")
				case "strDesc"
					Line = Replace(Line, "scrap of foil", "pedaco de papelao")
			End Select
		case 479
			Select case attr
				case "strName"
					Line = Replace(Line, "bag", "bolsa")
				case "strDesc"
					Line = Replace(Line, "potato chip bag", "saco de batata")
			End Select
		case 480
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, "patchwork foil poncho", "poncho de papelao retalhos")
			End Select
		case 481
			Select case attr
				case "strName"
					Line = Replace(Line, "memory stick", "cartao de memoria")
				case "strDesc"
					Line = Replace(Line, "Stoat's flashdrive for use at Camp Grayling", "O flashdrive de Stoat para uso em Camp Grayling")
			End Select
		case 482
			Select case attr
				case "strName"
					Line = Replace(Line, "move back", "voltar para tras")
				case "strDesc"
					Line = Replace(Line, "Move Back", "Voltar para tras")
			End Select
		case 483
			Select case attr
				case "strName"
					Line = Replace(Line, "key", "chave")
				case "strDesc"
					Line = Replace(Line, "cylindrical key", "chave cilindrica")
			End Select
		case 484
			Select case attr
				case "strName"
					...
					End If
				case "strDesc"
					Line = Replace(Line, "blueprints of the V-MADS system", "planos do sistema V-MADS")
			End Select
		case 485
			Select case attr
				case "strName"
					Line = Replace(Line, "card", "cartao")
				case "strDesc"
					Line = Replace(Line, "ID card", "ID cartao")
			End Select
		case 488
			Select case attr
				case "strName"
					Line = Replace(Line, "who", "quem")
				case "strDesc"
					Line = Replace(Line, "Who", "Quem")
			End Select
		case 489
		...
		case 490
			Select case attr
				case "strName"
					Line = Replace(Line, "key", "chave")
				case "strDesc"
					Line = Replace(Line, "failsafe key", "chave de seguranca")
			End Select
		case 491
			Select case attr
				case "strName"
					Line = Replace(Line, "memory stick", "cartao de memoria")
				case "strDesc"
					Line = Replace(Line, "Hatter's flashdrive for use at Camp Grayling", "O flashdrive do Hatter para uso em Camp Grayling")
			End Select
		case 492
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (torso)", "roupas (torso)")
				case "strDesc"
					Line = Replace(Line, "gray shirt", "camisa cinza")
			End Select
		case 493
			Select case attr
				case "strName"
				...
				case "strDesc"
					Line = Replace(Line, "consume/use", "consumir/usar")
					Line = Replace(Line, "this to re-enter Camp Grayling", "voltar a entrar na Camp Grayling")
			End Select
		case 494
			Select case attr
				case "strName"
					Line = Replace(Line, "legendary reputation: elusive", "reputacao lendaria: evasivo")
				case "strDesc"
					Line = Replace(Line, "legendary reputation for eluding capture", "reputacao lendaria por ser evasivo a captura")
			End Select
		case 495
			Select case attr
				case "strName"
					Line = Replace(Line, "legendary reputation: unstoppable", "reputacao lendaria: imparavel")
				case "strDesc"
					Line = Replace(Line, "legendary reputation for being unstoppable", "reputacao lendaria por ser imparavel")
			End Select		
		case 496
			Select case attr
				case "strName"
		...
		case 498
			Select case attr
				case "strName"
					Line = Replace(Line, "radio DMC support (blind)", "suporte de radio DMC (cego)")
				case "strDesc"
					Line = Replace(Line, "radio DMC support", "suporte de radio DMC")
			End Select
		case 499
			Select case attr
				case "strName"
					Line = Replace(Line, "roadmap", "guia de rota")
				case "strDesc"
					Line = Replace(Line, "Gill and Burton"&chr(34)&"Roads and Routes of Michigan"&chr(34)&" roadmap", "Gill e Burton "&chr(34)&"estradas e rotas do Michigan"&chr(34)&" guia de rota") 
			End Select
		case 500
			Select case attr
				case "strName"
					Line = Replace(Line, "spy", "espiar")
				case "strDesc"
					Line = Replace(Line, "Spy (drone)", "Espiar (drone)")
			End Select
		case 501
			Select case attr
				case "strName"
					Line = Replace(Line, "GUI Container", "GUI Container")
				case "strDesc"
					Line = Replace(Line, "Abilities you've chosen", "Habilidades que voce escolheu")
			End Select
		case 502
			Select case attr
				case "strName"
					Line = Replace(Line, "GUI Container", "GUI Container")
				case "strDesc"
					Line = Replace(Line, "Flaws you have chosen", "Falhas que voce escolheu")
			End Select
		case 503
			Select case attr
				case "strName"
					Line = Replace(Line, "mixed veggie bowl", "tigela mista de vegetais")
				case "strDesc"
					Line = Replace(Line, "mixed veggie bowl", "tigela mista de vegetais")
			End Select
		case 504
			Select case attr
				case "strName"
					Line = Replace(Line, "mixed veggie bowl w/protein", "tigela mista de vegetais com proteinas")
				case "strDesc"
					Line = Replace(Line, "mixed veggie bowl w/protein", "tigela mista de vegetais com proteinas")
			End Select
		case 505
			Select case attr
				case "strName"
					Line = Replace(Line, "sweet and sour seagull wings", "asas de gaivota azedo e azeda")
				case "strDesc"
					Line = Replace(Line, "sweet and sour seagull wings", "asas de gaivota azedo e azeda")
			End Select
		case 506
			Select case attr
				case "strName"
					Line = Replace(Line, "tenders", "propostas")
				case "strDesc"
					Line = Replace(Line, "tenders", "propostas")
			End Select
		case 507
			Select case attr
				case "strName"
					Line = Replace(Line, "non-veg stew", "Guisado sem vegetais")
				case "strDesc"
					Line = Replace(Line, "non-veg stew", "Guisado sem vegetais")
			End Select
		case 508
			Select case attr
				...
				case "strDesc"
					Line = Replace(Line, "consume/use", "consumir/usar")
					Line = Replace(Line, "this to re-enter the Last Chance Canteen", "voltar a entrar na Last Chance Canteen")
			End Select
		case 509
			Select case attr
				case "strName"
				...
				case "strDesc"
					Line = Replace(Line, "consume/use", "consumir/usar")
					Line = Replace(Line, "this to re-enter St. James Parkade", "voltar a entrar em St. James Parkade")
			End Select
		case 510
			Select case attr
				case "strName"
					Line = Replace(Line, "camp fixture", "equipamento fixo")
				case "strDesc"
					Line = Replace(Line, "dome light", "luz do domo")
			End Select
		case 511
			Select case attr
				case "strName"
					Line = Replace(Line, "camp fixture", "equipamento fixo")
				case "strDesc"
					Line = Replace(Line, "dashboard climate control", "painel de controle climatico")
			End Select
		case 512
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (legs)", "roupas (pernas)")
				case "strDesc"
					Line = Replace(Line, "short shorts", "shorts curto")
			End Select
		case 513
			Select case attr
				case "strName"
		...
		case 517
			Select case attr
				...
				case "strDesc"
					Line = Replace(Line, "blue pill", "pilula azul")
				case "strDescAlt"
					Line = Replace(Line, "Warfarin (prescription blood thinner)", "Warfarina (prescricao para sangue mais fino)")
			End Select
		case 518
			Select case attr
				case "strName"
					Line = Replace(Line, "bottle", "frasco")
				case "strDesc"
					Line = Replace(Line, "plastic pill bottle labeled: PharmaCon Warfarin", "Frasco de pilula de plastico rotulado: PharmaCon Warfarin")
				case "strDescAlt"
					Line = Replace(Line, "plastic pill bottle labeled: PharmaCon Warfarin (prescription blood-thinner)", "Frasco de comprimidos de plastico rotulado: PharmaCon Warfarin (medicamento para diluente de sangue)")
			End Select
		case 519
			Select case attr
				case "strName"
		...
		case 520
			Select case attr
				case "strName"
					Line = Replace(Line, "exploit", "explorar")
				case "strDesc"
					Line = Replace(Line, "exploit", "explorar")
			End Select
		case 521
		...
		case 522
			Select case attr
				case "strName"
					Line = Replace(Line, "trap", "armadilha")
				case "strDesc"
					Line = Replace(Line, "trap", "armadilha")
			End Select
		case 523
			Select case attr
				...
				case "strDesc"
					Line = Replace(Line, "orange pill", "pilula laranja")
				case "strDescAlt"
					Line = Replace(Line, "L-thyroxine (synthetic thyroid hormone)", "L-tiroxina (hormonio tireoidiano sintetico)")
			End Select
		case 524
			Select case attr
				case "strName"
					Line = Replace(Line, "bottle", "frasco")
				case "strDesc"
					Line = Replace(Line, "plastic pill bottle labeled: PharmaCon L-thyroxine", "Frasco de comprimidos de plastico rotulado: PharmaCon L-thyroxine")
				case "strDescAlt"
					Line = Replace(Line, "plastic pill bottle labeled: PharmaCon L-thyroxine (synthetic thyroid hormone)", "Frasco de comprimidos de plastico rotulado: PharmaCon L-thyroxine (hormonio tireoidiano sintetico)")
			End Select
		case 525
			Select case attr
				case "strName"
				...
				case "strDesc"
					Line = Replace(Line, "white pill", "pilula branca")
				case "strName"
					Line = Replace(Line, "Losepine (prescription antacid)", "Losepina (anti-acido de prescricao)")
			End Select
		case 526
			Select case attr
				case "strName"
					Line = Replace(Line, "bottle", "frasco")
				case "strDesc"
					Line = Replace(Line, "plastic pill bottle labeled: PharmaCon Losepine", "Frasco de pilula de plastico rotulado: PharmaCon Losepine")
				case "strName"
					Line = Replace(Line, "plastic pill bottle labeled: PharmaCon Losepine (prescription antacid)", "Frasco de comprimido de plastico rotulado: PharmaCon Losepine (antacidade com receita medica)")
			End Select
		case 527
			Select case attr
				case "strName"
					Line = Replace(Line, "pill organizer", "organizador de comprimidos")
				case "strDesc"
					Line = Replace(Line, "pill organizer", "organizador de comprimidos")
			End Select
		case 528
			Select case attr
				case "strName"
					Line = Replace(Line, "camp fixture", "equipamento fixo")
				case "strDesc"
					Line = Replace(Line, "communal trash barrel fire", "fogo do barril do lixo comunal")
			End Select
		case 529
			Select case attr
				case "strName"
					Line = Replace(Line, "corpse", "cadaver")
				case "strDesc"
					Line = Replace(Line, "dog corpse", "cadaver de cachorro")
			End Select
		case 530
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (shoes)", "roupas (sapatos)")
				case "strDesc"
					Line = Replace(Line, "running shoe (left)", "sapato de corrida (esquerda)")
			End Select
		case 531
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (shoes)", "roupas (sapatos)")
				case "strDesc"
					Line = Replace(Line, "running shoe (right)", "sapato de corrida (direito)")
			End Select
		case 532
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (shoes)", "roupas (sapatos)")
				case "strDesc"
					Line = Replace(Line, "makeshift rag shoe", "sapato improvisado")
			End Select
		case 533
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (shoes)", "roupas (sapatos)")
				case "strDesc"
					Line = Replace(Line, "sandals (left)", "sandalias (esquerda)")
			End Select
		case 534
			Select case attr
				case "strName"
					Line = Replace(Line, "shoe sole", "sola do sapato")
				case "strDesc"
					Line = Replace(Line, "shoe sole", "sola do sapato")
			End Select
		case 535
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (shoes)", "roupas (sapatos)")
				case "strDesc"
					Line = Replace(Line, "sandals (right)", "sandalias (direita)")
			End Select
		case 536
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (shoes)", "roupas (sapatos)")
				case "strDesc"
					Line = Replace(Line, "shoes (left)", "sapatos (esquerda)")
			End Select
		case 537
			Select case attr
				case "strName"
					Line = Replace(Line, "clothes (shoes)", "roupas (sapatos)")
				case "strDesc"
					Line = Replace(Line, "shoes (right)", "sapatos (direito)")
			End Select		
	End Select	
	itemtypes = CStr(Line)
End Function
...
Function recipes(id, attr, Line)		
	Select case id
		...
		case 93
			Select case attr
				case "strName"
					Line = Replace(Line, "smudge stick (lit)", "galho de incenso (aceso)")
			End Select
		case 94
			Select case attr
				case "strName"
